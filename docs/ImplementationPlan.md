...
First-pass working pipelines now exist for the minimum role set:
...
See [Autopilot Pipeline Contracts](./AutopilotPipelineContracts.md) for trigger payloads, webhook payloads, fallback stubs, and result shapes.
